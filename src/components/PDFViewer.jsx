...
//       setIsMobile(mobile);
//       if (!mobile) setSidebarOpen(false); // always close drawer on desktop
//     };
...
//     setPageNumber(page);
//     if (isMobile) setSidebarOpen(false); // auto-close drawer after selecting page
//   };
...
//             {/* Desktop / Tablet Sidebar (permanent) */}
//             {!isMobile && (
...
//             <Col xs={12} md={isMobile ? 12 : 9} lg={isMobile ? 12 : 10} ref={viewerContainerRef}>
//               {/* Progress */}
...
//                   {/* ===== UNIQUE BURGER BUTTON (mobile only) ===== */}
//                   {isMobile && (
//                     <Button
//                       size="sm"
...
//                           scale={scale}
//                           rotate={rotation}
//                           width={Math.min(window.innerWidth - (isMobile ? 24 : 48), 620 * scale)}
//                         />
